        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <Card className="text-center p-8 hover:shadow-xl transition-shadow">
            <CardContent className="p-0">
              <div className="w-32 h-32 mx-auto mb-6 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center relative overflow-hidden">
                <Image
                  src="/images/jainarainchouksey.jpeg"
                  alt="Chairman"
          ...
          <Card className="text-center p-8 hover:shadow-xl transition-shadow">
            <CardContent className="p-0">
              <div className="w-32 h-32 mx-auto mb-6 rounded-full bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center relative overflow-hidden">
                <Image
                  src="/images/choukseymam.jpeg"
                  alt="Director"
                  width={112}
                  height={112}
                  className="rounded-full object-cover"
          ...
          <Card className="text-center p-8 hover:shadow-xl transition-shadow">
            <CardContent className="p-0">
              <div className="w-32 h-32 mx-auto mb-6 rounded-full bg-gradient-to-br from-purple-400 to-purple-600 flex items-center justify-center relative overflow-hidden">
                <Image
                  src="/images/anupamchouksey.jpeg"
                  alt="Vice Chairman"
                  width={112}
                  height={112}
                  className="rounded-full object-cover"
