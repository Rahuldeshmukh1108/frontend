...
const galleryImages = [
  ...
  { id: 13, src: "/placeholder.svg?height=400&width=600", alt: "Campus Garden", category: "Campus" },
  { id: 14, src: "/placeholder.svg?height=400&width=600", alt: "Lecture Hall", category: "Academics" },
  { id: 15, src: "/placeholder.svg?height=400&width=600", alt: "Chemistry Lab", category: "Labs" },
  { id: 16, src: "/placeholder.svg?height=400&width=600", alt: "Basketball Court", category: "Sports" },
  { id: 17, src: "/placeholder.svg?height=400&width=600", alt: "Student Lounge", category: "Life" },
  { id: 18, src: "/placeholder.svg?height=400&width=600", alt: "Conference Room", category: "Events" },
]
