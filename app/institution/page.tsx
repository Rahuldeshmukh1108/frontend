 ...
 const featuredInstitutions = [
  {
    ...
    image: "/images/main2.jpg", // ✅ Removed query params
  },
  {
    name: "LNCT University",
    description: "Premier university offering undergraduate, postgraduate, and doctoral programs across multiple disciplines.",
    location: "Kolar road ,Bhopal, Madhya Pradesh",
    established: "2015",
    programs: ["Engineering", "Computer Applications", "Research"],
    website: "https://lnctu.ac.in",
    image: "/images/lnctuni.jpeg", // ✅ Removed query params
  },
  {
    name: "JNCT",
    ...
    image: "/images/jnctt.jpg", // ✅ Removed query params
  },
];
